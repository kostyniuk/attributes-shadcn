...
export const Status = () => {
    const data = TAB_DATA[ATTRIBUTE_TYPES.JOB].status.data as StatusItem[];
    ...
    return (
        <div className="mt-4 space-y-3 rounded-md border p-4">
            <form id="job-status-form" onSubmit={(e) => {
                e.preventDefault();
                form.handleSubmit();
            }}>
                <form.Field name="statuses" mode="array">
                    {(field) => (
                        <div>
                            <FieldGroup>
                                <FieldSet>
                                    <FieldLegend>Job Status</FieldLegend>
                                    <FieldDescription>
                                        Status name
                                    </FieldDescription>
                                    <FieldGroup>
